...
<body>
  ...
  <nav class="navbar navbar-inverse">
    ...
    <div class="container-fluid">
      ...
      <ul class="nav navbar-nav">
        <li class="active"><a href="home1.php">Home<i class="fa fa-fw fa-home"></i></a></li>
  ...
  <div class="font" style="color:sand; margin-top : 35%;  ">
    <h1 class="font" style="font-size: 400%; text-shadow:2px 4px 4px #fff;">Welcome to Qigmo</h1>
    <!-- <h1 class="font" style="font-size: 400%; text-shadow: 1px 1px 2px black, 0 0 25px LightGray, 0 0 5px white;">Welcome to Qigmo</h1> -->
    <p style="font-size: 150%;">The special charm and the cosy mood of Qigmo will make you feel as a true fiorentine in Florence.</p>
  </div>
